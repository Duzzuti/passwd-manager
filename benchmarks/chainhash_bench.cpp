...
TEST(ChainHash, normal) {
    ...
    std::vector<ChainHash> chainhashes = {
        ChainHash{CHModes(ichash), iterations[0], chd1},
        ChainHash{CHModes(ichash), iterations[1], chd1},
        ChainHash{CHModes(ichash), iterations[2], chd1}
    };
