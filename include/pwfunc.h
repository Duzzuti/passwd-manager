...
public:
    ...
    Bytes chainhashWithQuadraticCountSalt(const std::string password, const u_int64_t iterations=1, u_int64_t salt_start=1, const u_int64_t a=1, const u_int64_t b=1, const u_int64_t c=1) const noexcept;
    ...
    //adds a quadratic count salt each iteration
    Bytes chainhashWithQuadraticCountSalt(const Bytes data, const u_int64_t iterations=1, u_int64_t salt_start=1, const u_int64_t a=1, const u_int64_t b=1, const u_int64_t c=1) const noexcept;
