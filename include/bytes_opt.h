...
class BytesOpt {
   ...
   public:
    ...
    bool operator==(const BytesOpt& b2) const noexcept;                  // returns true if the byte arrays of the two Byte objects are equal
    bool operator!=(const BytesOpt& b2) const noexcept;                  // returns true if the byte arrays of the two Byte objects are not equal
