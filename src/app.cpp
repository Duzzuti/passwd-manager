...
Bytes App::askForHeader() const{
    ...
    CHModes chainhash_mode1 = this->askForChainHashMode();std::cout << std::endl;     //chainhash1 mode
    ...
    CHModes chainhash_mode2 = this->askForChainHashMode();std::cout << std::endl; //chainhash2 mode
